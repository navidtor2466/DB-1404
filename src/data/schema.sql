...
INSERT INTO cities (city_id, name, description, province, country, latitude, longitude) VALUES
    ('a1000000-0000-0000-0000-000000000001', 'اصفهان', 'نصف جهان، شهر هنر و معماری ایران', 'اصفهان', 'ایران', 32.6546, 51.6680),
    ('a1000000-0000-0000-0000-000000000002', 'شیراز', 'شهر شعر و گل، زادگاه حافظ و سعدی', 'فارس', 'ایران', 29.5918, 52.5836),
    ('a1000000-0000-0000-0000-000000000003', 'یزد', 'شهر بادگیرها و اولین شهر خشتی جهان', 'یزد', 'ایران', 31.8974, 54.3569),
    ('a1000000-0000-0000-0000-000000000004', 'کاشان', 'شهر گلاب و خانه‌های تاریخی زیبا', 'اصفهان', 'ایران', 33.9850, 51.4100),
    ('a1000000-0000-0000-0000-000000000005', 'تبریز', 'شهر اولین‌ها و بازار تاریخی بزرگ', 'آذربایجان شرقی', 'ایران', 38.0800, 46.2919);

-- Insert Places
INSERT INTO places (place_id, city_id, name, description, latitude, longitude) VALUES
    ('b1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'میدان نقش جهان', 'یکی از بزرگترین میادین تاریخی جهان و میراث جهانی یونسکو', 32.6572, 51.6780),
    ('b1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000001', 'سی و سه پل', 'پل تاریخی و نماد شهر اصفهان بر روی زاینده‌رود', 32.6431, 51.6611),
    ('b1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000002', 'تخت جمشید', 'کاخ هخامنشیان و یکی از مهم‌ترین آثار باستانی جهان', 29.9349, 52.8918),
    ('b1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000002', 'حافظیه', 'آرامگاه حافظ شیرازی، شاعر بزرگ ایران', 29.6202, 52.5481),
    ('b1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000003', 'مسجد جامع یزد', 'مسجدی با بلندترین مناره‌های ایران', 31.8979, 54.3556);

-- Insert Place Features
INSERT INTO place_features (place_id, feature) VALUES
    ('b1000000-0000-0000-0000-000000000001', 'میراث یونسکو'),
    ('b1000000-0000-0000-0000-000000000001', 'بازار سنتی'),
    ('b1000000-0000-0000-0000-000000000001', 'معماری صفوی'),
    ('b1000000-0000-0000-0000-000000000003', 'میراث یونسکو'),
    ('b1000000-0000-0000-0000-000000000003', 'باستان‌شناسی');
